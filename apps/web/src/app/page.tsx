    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground transition-colors duration-200">
      ...
      <main className="flex-1 pt-20">
        <section className="relative overflow-hidden py-20 lg:py-32">
          ...
          <div className="absolute top-0 left-1/4 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-indigo-200/20 dark:bg-indigo-900/10 blur-3xl" />
          <div className="absolute right-0 top-10 h-[400px] w-[400px] rounded-full bg-purple-200/20 dark:bg-purple-900/10 blur-3xl" />
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="mt-6 font-outfit text-4xl font-extrabold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Dynamic Forms Powered by Gemini AI
              </h1>
              ...
              <div className="rounded-xl border border-border bg-card shadow-inner overflow-hidden">
                ...
                <div className="p-8 bg-muted/50 flex flex-col gap-6 text-left">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-lg font-bold text-foreground font-outfit">My Forms Dashboard</h3>
                      <p className="text-xs text-muted-foreground">Manage your dynamic forms and AI summaries</p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="rounded-xl border border-border bg-card p-4 shadow-sm">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-xs text-muted-foreground">AI Insights Run</div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative flex flex-col gap-4 rounded-2xl border border-border bg-muted/20 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-outfit font-semibold text-foreground text-lg">AI Form Generator</h3>
              ...
              <div className="relative flex flex-col gap-4 rounded-2xl border border-border bg-muted/20 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-outfit font-semibold text-foreground text-lg">Drag & Drop Builder</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="relative flex flex-col gap-4 rounded-2xl border border-border bg-muted/20 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-outfit font-semibold text-foreground text-lg">Instant Themes</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="relative flex flex-col gap-4 rounded-2xl border border-border bg-muted/20 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-outfit font-semibold text-foreground text-lg">Recharts Analytics</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="relative flex flex-col gap-4 rounded-2xl border border-border bg-muted/20 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-outfit font-semibold text-foreground text-lg">Visibility Toggles</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="relative flex flex-col gap-4 rounded-2xl border border-border bg-muted/20 p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-outfit font-semibold text-foreground text-lg">Developer Integrations</h3>
                <p className="text-muted-foreground text-sm">
      ...
      <footer className="border-t border-border bg-muted py-10 transition-colors duration-200">
        <div className="container mx-auto px-4 text-center text-muted-foreground text-sm flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© 2026 Formu.AI. All rights reserved.</p>
          <div className="flex gap-4">
            <Link href="/explore" className="hover:text-indigo-600 dark:hover:text-indigo-400">Explore Templates</Link>
            <Link href="/pricing" className="hover:text-indigo-600 dark:hover:text-indigo-400">Pricing</Link>
            <a href="http://localhost:4000/docs" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 dark:hover:text-indigo-400">API Docs</a>
          </div>
        </div>
      </footer>
    </div>
